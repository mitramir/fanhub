  ...
  <div class="site-wrap">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              <h2 class="caption mb-2">Basketball for everybody</h2>
              <h1 class="">Welcome To MG World</h1>
    ...
    <div class="site-block-half d-flex">
      ...
      <div class="text">
        ...
        <p><a href="#" class="btn btn-primary pill px-4 py-3 text-white">Read More</a></p>
        ...
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="img-border">
                <a href="https://www.youtube.com/watch?v=XmZRFXJhLrQ" class="popup-vimeo image-play">
      ...
      <div class="container">
        ...
        <div class="nonloop-block-15 owl-carousel">
            ...
            <div class="media-with-text p-md-5">
              ...
              <span class="mb-3 d-block post-date">August 9th, 2020 &bullet; By <a href="#">Admin</a></span>
            ...
            <div class="media-with-text p-md-4">
              ...
              <span class="mb-3 d-block post-date">Dec 20th, 2019 &bullet; By <a href="#">Admin</a></span>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p>
            </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6 mx-auto text-center mb-5 section-heading">
            <h2 class="mb-5">Training Features</h2>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="text-center item">
              ...
              <h2 class="h5">Basketball Ball</h2>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde temporibus</p>
            </div>
          </div>
        ...
        <div class="row align-items-stretched">
          ...
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="pricing p-5 h-100 text-center">
              <div class="text-center mb-4">
                <h3 class="h4 mb-4">10 Days Basketball Class</h3>
          ...
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="pricing p-5 h-100 text-center">
              <div class="text-center mb-4">
                <h3 class="h4 mb-4">20 Days Basketball Class</h3>
          ...
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="pricing p-5 h-100 text-center">
              <div class="text-center mb-4">
                <h3 class="h4 mb-4">30 Days Basketball Class</h3>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <h3 class="footer-heading mb-4 text-white">Ministries</h3>
                  <ul class="list-unstyled">
                    <li><a href="#">Game for Soul</a></li>
                    <li><a href="#">Play for Resilience</a></li>
                    <li><a href="#">Training Class</a></li>
